  ...
  return (
    <AdminLayout title="About Section Management">
      <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="speech">Speech/Message *</Label>
                    <Textarea
                      id="speech"
                      placeholder="Enter the message or speech content..."
        ...
        {/* Preview Card */}
        {(formData.name || formData.designation || formData.speech || imagePreview) && (
          <Card className="bg-card/30 backdrop-blur border-border/30">
            <CardHeader>
              <CardTitle>Preview</CardTitle>
              <CardDescription>How this will appear on the about page</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    {formData.speech || "Speech content will appear here..."}
                  </p>
                </div>
              </div>
            </CardContent>
